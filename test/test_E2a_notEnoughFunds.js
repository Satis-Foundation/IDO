...
describe ("Withdraw more fund than possible", function() {
    it ("Not enough mobile fund", async function() {
        ...
        const ido = await idoContract.deploy(fakeUSDCAddress,satisTokenAddress,sumSatisToken,15);
        ...
        */
        ...
        await ido.connect(clientX).withdrawAssets(1000);
        usdcValueX = await ido.connect(clientX).viewPersonalAssets();
    })
}) 