...
describe ("Test view with non-whitelister", function() {
    it ("View whitelist", async function() {
        ...
        //Non-whitelisted guy try to view whitelisted ppl
        await ido.connect(clientA).viewUserWhiteList(idoContractOwnerAddress);
